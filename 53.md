...
```jsonc
{
  "kind": 1311,
  "tags": [
    ["a", "30311:<Community event author pubkey>:<d-identifier of the community>", "<relay-hint>"],
  ],
...
```json
{
  ...
  "kind": 1311,
  "tags": [
    ["a", "30311:1597246ac22f7d1375041054f2a4986bd971d8d196d7997e48973263ac9879ec:demo-cf-stream", "<relay-hint>"]
  ],
  "content": "Zaps to live streams is beautiful.",
